...
const LuaBinaryBundlePlugin = require("../scripts/bundle.js")
...
module.exports = {
    ...
    module: {
        ...
        rules: [
            ...
            // It's important to do this before Babel processes the JS.
            {
                ...
                options: {
                    search: '/static/media/index.html',
                    replace: `/static/${moduleConfig.namespace}/media/index.html`,
                }
            },
            {
                test: /start\.js$/,
    ...
    plugins: [
        ...
        new LuaBundlerPlugin({ namespace: moduleConfig.namespace, entryRegExp: /main\.[a-f0-9]{8}\.js$/ }),
        new LuaBinaryBundlePlugin({ namespace: moduleConfig.namespace, webAppPath: moduleConfig.flutterAppPath }),
    ],
